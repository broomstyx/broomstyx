...
registerBroomstyxObject(UserFunction, SurfingBC_dispX)
        
SurfingBC_dispX::SurfingBC_dispX() {}

SurfingBC_dispX::~SurfingBC_dispX() {}

double SurfingBC_dispX::at( const RealVector& coor, const TimeData& time )
{
