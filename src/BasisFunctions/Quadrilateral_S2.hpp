...
#ifndef QUADRILATERAL_S2_HPP
#define QUADRILATERAL_S2_HPP
...
namespace broomstyx
{
    class Quadrilateral_S2 final : public ScalarBasisFunction
    {
    public:
        Quadrilateral_S2();
        virtual ~Quadrilateral_S2();
