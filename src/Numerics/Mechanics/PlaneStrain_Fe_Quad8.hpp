...
#ifndef PLANESTRAIN_FE_QUAD8_HPP
#define	PLANESTRAIN_FE_QUAD8_HPP
...
namespace broomstyx
{
    ...
    class CellNumericsStatus_PlaneStrain_Fe_Quad8 final : public NumericsStatus
    {
        friend class PlaneStrain_Fe_Quad8;
        
    public:
        CellNumericsStatus_PlaneStrain_Fe_Quad8( int nGausspts );
        virtual ~CellNumericsStatus_PlaneStrain_Fe_Quad8();
    ...
    class EvalPtNumericsStatus_PlaneStrain_Fe_Quad8 final : public NumericsStatus
    {
        friend class PlaneStrain_Fe_Quad8;
    ...
    class PlaneStrain_Fe_Quad8 final : public Numerics
    {
    public:
        PlaneStrain_Fe_Quad8();
        virtual ~PlaneStrain_Fe_Quad8();
...
#endif	/* PLANESTRAIN_FE_QUAD8_HPP */