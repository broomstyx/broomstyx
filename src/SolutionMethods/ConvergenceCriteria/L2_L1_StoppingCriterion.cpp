...
L2_L1_Norms::L2_L1_Norms() {}

L2_L1_Norms::~L2_L1_Norms() {}

bool L2_L1_Norms::checkSolutionConvergence()
{

}

void L2_L1_Norms::computeResidalNorms( const std::vector<RealVector>& resid, const std::vector<Dof*>& dof )
{

}

void L2_L1_Norms::processResidualContribution( std::vector<Dof*> dof, RealVector contrib )
{
    // Assembly
